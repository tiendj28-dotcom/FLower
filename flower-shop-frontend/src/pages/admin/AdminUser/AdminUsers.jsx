...
export default function AdminUsers() {
  ...
  const getRoleInfo = (roleId) => {
    switch (roleId) {
      ...
      case 2:
        return { label: 'Nhân viên', className: 'bg-blue-500/10 text-blue-700 border-blue-500/20' };
    ...
    <div className="p-4 sm:p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="mb-4">
          <TabsTrigger value="2">Nhân viên</TabsTrigger>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={createForm.role_id} onValueChange={(value) => handleCreateChange('role_id', value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="2">Nhân viên quầy</SelectItem>
                    <SelectItem value="3">Nhân viên trực web</SelectItem>
                  </SelectContent>
                </Select>
