            ...
            <div>
              ...
              <div className="space-y-1">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive
            ...
            <div>
              ...
              <div className="space-y-1">
                <NavLink
                  ...
                  onClick={() => setMobileMenuOpen(false)}
                  className={({ isActive }) =>
                    `w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive ? "bg-primary text-white" : "text-muted-foreground hover:bg-secondary"
                    }`
                  }
                >
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <span className="text-sm tracking-wide">Danh mục</span>
                </NavLink>
                ...
                >
                  ...
                  <span className="text-sm tracking-wide">Sản phẩm</span>
                </NavLink>
              </div>
            </div>
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((item) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${Number(item.is_read) === 0 ? "bg-orange-50 dark:bg-amber-900/20" : "bg-white dark:bg-gray-800"
                          }`}
                      >
